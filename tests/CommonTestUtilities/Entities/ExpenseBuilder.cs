...
{
    public static List<Expanse> Collection(User user, uint count = 2)
    {
        var list = new List<Expanse>();
    ...
    public static Expanse Build(User user)
    {
        return new Faker<Expanse>()
            .RuleFor(u => u.Id, _ => 1)
