...
public class RegisterExpanseTest : IClassFixture<CustomWebApplicationFactory>
{
    ...
    public RegisterExpanseTest(CustomWebApplicationFactory webApplicationFactory)
    {
