...
public class DoLogin
{
    ...
    public async Task Error_User_Not_Found()
    {
        ...
        result.Where(ex => ex.GetErrors().Count() == 1 && ex.GetErrors().Contains(ResourcesErrorMessage.EMAIL_OR_PASSWORD_INVALID));
    }
    ...
    {
        var passwordEncrypter = new BCryptBuilder().Verify(password).Build();
